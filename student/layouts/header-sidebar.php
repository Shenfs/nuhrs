...
$geActiveInfo = mysqli_query($conn, "SELECT *, users.id AS user_id FROM users INNER JOIN students ON users.id = students.userID WHERE users.id='$active_id'");
while ($row = $geActiveInfo->fetch_assoc()) {
    ...
    $active_student_id_number = $row['student_id_number'];
    $active_course_id = $row['courseID'];
    $active_year = $row['year'];
    $active_section = $row['section'];
    $active_birthdate = $row['birthdate'];
    $active_province = $row['province'];
    $active_city_municipality = $row['city_municipality'];
    $active_barangay = $row['barangay'];
    $active_nationality = $row['nationality'];
    $active_sex = $row['sex'];
    $active_contact_number = $row['contact_number'];
    $active_religion = $row['religion'];
    $active_age = $row['age'];
    $active_emergency_person_name = $row['emergency_person_name'];
    $active_emergency_relationship = $row['emergency_relationship'];
    $active_emergency_contact_number = $row['emergency_contact_number'];
    $active_emergency_address = $row['emergency_address'];
    $active_avatar = $row['profile_img'];
    $active_status = $row['status'];
}
$get_active_student_id = mysqli_query($conn, "SELECT id FROM students WHERE userID='$active_id'");
$get_active_student_id = $get_active_student_id->fetch_assoc();
$active_student_id = $get_active_student_id['id'];

if($active_status == "Inactive"){
    include_once("../Utilities/alert.php");
    alert("warning","Your account is inactive","Please contact Administrator","../login.php");
}
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="medical-appointment.php">Medical</a>
                        <a class="collapse-item" href="dental-appointment.php">Dental</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="medical-health-record.php">Medical</a>
                        <a class="collapse-item" href="dental-health-record.php">Dental</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <h6 id="clock" class="text-center d-flex align-items-center justify-content-center text-dark font-weight-bold"></h6>
                        <script>
                            clock();
