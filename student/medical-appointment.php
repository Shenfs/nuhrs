...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <button class="btn btn-primary" data-toggle="modal" data-target="#setMedicalAppointmentModal">Set Medical Appointment</button>
        </div>
    </div>
    <div class="row border border-rounded p-3 mt-3 shadow">
        <div class="col">
        <h3 class="font-weight-bold text-dark">Medical Appointment History</h3>
            <table id="medical_appointment_history" class="table table-bordered" style="width: 100%;">
                <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php
                            switch($row['appointment_status']){
                                ...
                                case "Success" : echo "<p class='text-light border bg-success rounded text-center  font-weight-bold p-1'>Success</p>";break;
...
<!-- /.container-fluid -->
<!-- Set Medical Appointment Modal -->
<!-- Modal -->
<div class="modal fade" id="setMedicalAppointmentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-calendar-plus mr-2"></i>Set Medical Appointment</h5>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="appointment_type" value="Medical">
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <?php 
              ...
              $datenow = date('Y-m-d');
              $selectAllDoctorProfessional = mysqli_query($conn,"SELECT *, medicalprofessional.id as med_prof_id  FROM users INNER JOIN medicalprofessional ON users.id = medicalprofessional.userID WHERE medicalprofessional.specialization='Doctor'");
              while($row = $selectAllDoctorProfessional->fetch_assoc()){?>
        ...
        <div class="row">
          <div class="col">
            <label>Date</label>
            <input type="text" class="form-control"  name="from_date" id="from_date" autocomplete="off" onkeydown="return false" required>
          </div>
          ...
          $("#from_date").change(function () {
              ...
              if(from_date) {
                  ...
                  $.ajax({
                      ...
                      type: "POST",
                      data: { date: from_date, appointment_type: "Medical"},
                      success: function(data) {
                          console.log(data);
                          $('#from_time').empty();
...
<script>
    $(function() {
        $("#medical_appointment_history").dataTable();
    });
</script>
