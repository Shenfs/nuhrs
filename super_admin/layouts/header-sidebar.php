...
$geActiveInfo = mysqli_query($conn,"SELECT *, users.id AS user_id FROM users");
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a href='lab-result.php' class='collapse-item'>Lab Result</a>
                        <a href='vaccine_record.php' class='collapse-item'>Vaccine Records</a>
                    </div>
                </div>
            </li>
