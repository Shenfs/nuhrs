                    ...
                    while($row = $selectDentalHealthRecords->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around align-items-center">
                                ...
                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editDenRecordModal<?php echo $row['den_record_id'];?>"><i class="fas fa-edit"></i></button>
                                <form action="../Controller/dental-health-record-print.php" method="POST">
                                    <input type="hidden" name="den_record_id" value="<?php echo $row['den_record_id'];?>">
                                    <button type="submit" class="btn btn-secondary btn-sm"><i class="fas fa-print"></i></button>
                                </form>
                            </td>
                        </tr>
